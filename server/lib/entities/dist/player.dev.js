...
function (_Entity) {
  ...
  function Player(cohort, position, grid, id) {
    var _this;

    _classCallCheck(this, Player);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Player).call(this, cohort, position, grid, id));
    _this.color = (0, _utilities.generateRandomColor)();
    _this.geometry = "cube";
    return _this;
  }
  ...
  _createClass(Player, [{
    ...
    value: function getState() {
      var payload = _objectSpread({}, _get(_getPrototypeOf(Player.prototype), "getState", this).call(this), {
        color: this.getColor(),
